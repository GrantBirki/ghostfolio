...
DOMAIN=money.birki.io # the domain to serve traffic with
REPO=https://github.com/GrantBirki/ghostfolio # the repo to clone
REPO_DIR=/home/ghostfolio # the dir of the repo cloned
VM_USER=ghostfolio # the name of the vm user
